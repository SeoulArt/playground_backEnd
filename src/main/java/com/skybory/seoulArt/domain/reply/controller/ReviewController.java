...
//	@PostMapping(value = "",  consumes = "multipart/form-data")	// 완성
	...
	public ResponseEntity<ReviewResponse> createReview(@ModelAttribute CreateReviewRequest request, HttpServletRequest servletRequest) throws IOException {
	...
	@ApiResponse(responseCode="200", description="성공")
	@ApiResponse(responseCode="400", description="에러")
	public ResponseEntity<ReviewResponse> putReview(@ModelAttribute CreateReviewRequest request, HttpServletRequest servletRequest, @PathVariable("reviewId") Long reviewId) throws IOException {
	...
	@ApiResponse(responseCode="200", description="성공")
	@ApiResponse(responseCode="400", description="에러")
	public ResponseEntity<List<ReviewResponse>> getReviewList(@PathVariable("playId") Long playId) {
	...
	@Secured({"ROLE_USER", "ROLE_ADMIN" , "ROLE_EDITOR"})
